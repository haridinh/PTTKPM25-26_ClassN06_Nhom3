...
@section('contentData')
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-4">
            <x-message />
            <form action="{{ route('customer.deposit.store') }}" method="post" enctype="multipart/form-data"
                class="py-4">
                @csrf
                ...
                <div class="floating-form-group mb-4">
                    ...
                    <textarea class="floating-form-control" placeholder="Deposit Comments" rows="5" name="deposit_comments"
