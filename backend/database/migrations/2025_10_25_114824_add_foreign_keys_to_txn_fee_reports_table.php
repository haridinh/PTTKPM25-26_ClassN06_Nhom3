...
return new class extends Migration
{
    ...
    {
        Schema::table('txn_fee_reports', function (Blueprint $table) {
    ...
    {
        Schema::table('txn_fee_reports', function (Blueprint $table) {
            $table->dropForeign('txn_fee_reports_accept_currency_id_foreign');
            $table->dropForeign('txn_fee_reports_customer_id_foreign');
        });
    }
};
