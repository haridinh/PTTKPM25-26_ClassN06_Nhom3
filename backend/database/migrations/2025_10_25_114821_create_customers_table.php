...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->string('site_align', 100)->nullable();
            $table->rememberToken();
            ...
            $table->tinyInteger('merchant_verified_status')->default(0)->comment('0= did not submit info, 1= verified, 2=Cancel, 3=processing');
